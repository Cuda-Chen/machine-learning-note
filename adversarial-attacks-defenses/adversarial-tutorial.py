...
def generator_adversarials(batch_size):
    while True:
        x = []
        y = []
...
x_adversarial_train, y_adversarial_train = next(generator_adversarials(20000))
x_adversarial_test, y_adversarial_test = next(generator_adversarials(10000))

# Assess base model on adversarial data
print("Base accuracy on adversarial image:", model.evaluate(x=x_adversarial_test, y=y_adversarial_test, verbose=0))
